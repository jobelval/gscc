...
// ══════════════════════════════════════════════════════════
$lien_formulaire = 'https://h23xktcc.forms.app/gsccadhesion'; // ← mets ton lien ici
?>
<!DOCTYPE html>
<html lang="fr">
...
========================================================== */
        ...
        *::after {
        ...
        .hero-glow-gold {
            ...
            height: 500px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(217, 79, 122, .16) 0%, transparent 70%);
            bottom: -100px;
            right: -80px;
            pointer-events: none;
        }
        ...
        .hero-tag {
            ...
            border: 1px solid rgba(217, 79, 122, .35);
            color: var(--gold);
            font-size: 11px;
            font-weight: 600;
        ...
        .hero h1 em {
            font-style: italic;
            color: transparent;
            background: linear-gradient(90deg, var(--gold), #F07AA0);
        ...
        .def-card:nth-child(2) .def-card-ico {
            background: linear-gradient(135deg, var(--gold), #F07AA0);
        }

        .def-card:nth-child(3) .def-card-ico {
            background: linear-gradient(135deg, #003399, #1a56cc);
        }

        .def-card:nth-child(4) .def-card-ico {
            background: linear-gradient(135deg, var(--sage), #3DA085);
        }
        ...
        .type-card.featured .type-tag {
            background: rgba(217, 79, 122, .2);
            color: var(--gold);
        }

        .type-card.featured .type-ico {
            background: rgba(255, 255, 255, .1);
            color: var(--gold);
        }

        .type-card.featured .type-detail {
        ...
        .type-card.featured .type-ico .fas {
        ...
        .type-card.featured .type-details li i {
            color: var(--gold);
        }
        ...
        /* was text-3 (#7A7A9A) → text-2 (#3A3A5C) */
        .type-card.featured .type-detail {
        ...
        .cta-section {
            padding: 100px 0;
            background: linear-gradient(135deg, #003399 0%, #1a56cc 60%, #1a7abf 100%) !important;
            text-align: center;
            position: relative;
            overflow: hidden;
        }
        ...
        .cta-glow {
            ...
            height: 700px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(217, 79, 122, .18) 0%, transparent 70%);
            top: 50%;
            left: 50%;
 ...
 */
        .cta-section h2 em {
            ...
            color: var(--gold);
            /* repli visible */
            background: linear-gradient(90deg, #F07AA0, #D94F7A, #F07AA0);
            -webkit-background-clip: text;
            background-clip: text;
            -webkit-text-fill-color: transparent;
            /* plus fiable que color:transparent */
        }
        ...
        .cta-section p {
            ...
            /* légère ombre pour améliorer lisibilité */
        }
...
<body>
    ...
    <header class="hero">
        ...
        <div class="container">
            ...
            <h1 data-aos="fade-up" data-aos-delay="80">
                Rejoignez <em> la lutte </em><br>contre le cancer en Haïti
            </h1>

            <p class="hero-sub" data-aos="fade-up" data-aos-delay="160">
                Un membre, c’est quelqu’un qui s’engage concrètement,
            ...
            <div class="def-grid">
                ...
                <div data-aos="fade-right">
                    ...
                    <p class="section-text">
                        Chaque don est une action qui sauve des vies.
                        Nos membres sont <strong>des personnes engagées qui contribuent activement</strong>, notamment sur le plan financier, à faire avancer la lutte contre le cancer.
                    </p>
                    <p class="section-text" style="margin-top:16px;">
                        Que ce soit pour soutenir nos programmes de sensibilisation et de dépistage,<strong>ou pour financer le traitement </strong>des personnes
                        <strong>atteintes de cancer</strong>, chaque geste compte.<strong>Chaque don effectué a un impact direct : </strong>
                        il peut transformer une vie, redonner espoir, et sauver des vies.
                    </p>
                    <p class="section-text" style="margin-top:16px;">
                        Bonne nouvelle :
                        Les dons faits au GSCC sont déductibles d’impôts, car nous sommes reconnus comme organisation d’utilité publique (501(c)(3) en Haïti et aux États-Unis).
                    </p>
                    <p><strong>Ensemble, nous sommes plus forts que le cancer.</strong></p>
        ...
        <div class="container">
            ...
            <div class="types-grid">
                ...
                <div class="type-card" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <h3>Devenir membre contributeur</h3>
    ...
    <section class="benefits-section">
        <div class="container">
            <div data-aos="fade-up">
                ...
                <h2 class="section-title">Pourquoi<br><em>rejoindre</em> le GSCC ?</h2>
                <div class="section-rule"></div>
            </div>
            ...
            <div class="benefits-grid">
                ...
                <div class="benefit-card" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <h4>Contribuer à une cause essentielle</h4>
                    <p>Chaque engagement compte.
                        En rejoignant le GSCC, vous contribuez directement à offrir des soins, de l’information et de l’espoir aux personnes les plus vulnérables face au cancer en Haïti.</p>
                </div>
                ...
                <div class="benefit-card" data-aos="fade-up" data-aos-delay="80">
                    ...
                    <p>Le GSCC est reconnu d’utilité publique en Haïti et aux États-Unis.
                        Vos dons sont déductibles des impôts, vous permettant de soutenir une cause tout en bénéficiant d’avantages fiscaux.</p>
                </div>

                <div class="benefit-card" data-aos="fade-up" data-aos-delay="160">
                    <div class="benefit-card-ico"><i class="fas fa-newspaper"></i></div>
                    <h4> Rejoindre une communauté engagée</h4>
                    <p>Être membre du GSCC, c’est faire partie d’un réseau de personnes engagées.
                        Vous participez à la vie de l’organisation, recevez des informations exclusives et contribuez aux actions menées à travers tout le pays.</p>
                </div>

                <div class="benefit-card" data-aos="fade-up" data-aos-delay="0">
                    <div class="benefit-card-ico" style="background:linear-gradient(135deg,var(--gold),#F07AA0)"><i class="fas fa-chart-line"></i></div>
                    <h4> Reconnaissance de votre engagement</h4>
                    <p>Votre implication est valorisée.
                        Sur demande, le GSCC délivre un certificat d’engagement communautaire pouvant appuyer votre parcours académique ou professionnel.</p>
                </div>

                <!-- <div class="benefit-card" data-aos="fade-up" data-aos-delay="80">
                    <div class="benefit-card-ico" style="background:linear-gradient(135deg,#003399,#1a56cc)"><i class="fas fa-comments"></i></div>
    ...
    <section class="members-section">
        <div class="container">
            ...
            <div class="members-avatars" data-aos="fade-up">
                ...
                <div class="member-avatar-card" style="background:linear-gradient(135deg,#003399,#1a56cc);border-color:#003399;display:flex;flex-direction:column;align-items:center;justify-content:center;">
    ...
    <section class="cta-section">
        ...
        <div class="container">
            ...
            <div data-aos="fade-up">
                <h2>Prêt à rejoindre<br><em>la lutte pour le cancer en Haïti</em> ?</h2>
                <p>
