...
<style>
    ...
    .surv-hero {
        ...
        background:
            ...
            url('images/site/image1.jpg') center/cover no-repeat;
        overflow: hidden;
    ...
    .surv-hero-orbs span:nth-child(1) {
        width: 320px;
        height: 320px;
        top: -80px;
        right: -60px;
    ...
    .surv-hero-orbs span:nth-child(2) {
        width: 180px;
        height: 180px;
        bottom: 40px;
        left: 8%;
    ...
    .surv-hero-orbs span:nth-child(3) {
        width: 90px;
        height: 90px;
        top: 60px;
        left: 40%;
    ...
    .surv-card-photo {
        ...
        overflow: hidden;
        background:
            radial-gradient(ellipse 80% 80% at 50% 110%, rgba(255, 255, 255, 0.10) 0%, transparent 70%),
            linear-gradient(150deg, #7B1C3E 0%, var(--surv-rose-dark) 40%, var(--surv-rose) 100%);
        display: flex;
        align-items: center;
        justify-content: center;
        flex-shrink: 0;
    ...
    /* Motif décoratif en fond (sans photo) */
    .surv-card-photo::before {
        content: '';
        position: absolute;
        inset: 0;
        background:
            radial-gradient(circle 120px at 15% 20%, rgba(255, 255, 255, 0.06), transparent),
            radial-gradient(circle 80px at 85% 80%, rgba(255, 255, 255, 0.05), transparent);
        pointer-events: none;
        z-index: 0;
    }

    /* Image en background avec opacité réduite */
    .surv-card-photo.has-bg-photo::before {
        background-image: var(--surv-bg-img);
    ...
    /* Conteneur circulaire de la photo */
    .surv-photo-circle {
        position: relative;
        z-index: 2;
        width: 148px;
        ...
        align-items: center;
        justify-content: center;
        transition: transform 0.45s cubic-bezier(.34, 1.2, .64, 1), box-shadow 0.45s ease;
        flex-shrink: 0;
    }

    .surv-card:hover .surv-photo-circle {
    ...
    .surv-card:hover .surv-photo-circle img {
    ...
    .surv-modal-close:hover {
        background: rgba(200, 55, 95, 0.5);
    }
    ...
    .surv-modal-body::-webkit-scrollbar {
        width: 5px;
    }

    .surv-modal-body::-webkit-scrollbar-track {
        background: var(--surv-rose-pale);
    }

    .surv-modal-body::-webkit-scrollbar-thumb {
        background: var(--surv-rose-mid);
        border-radius: 3px;
    }
    ...
    .surv-btn-white:hover {
        background: var(--surv-rose-pale);
        color: var(--surv-rose-dark);
            ...
            <div class="surv-grid">
                ...
                ?>
                    <div class="surv-card" data-aos="fade-up" data-aos-delay="<?= ($i % 3) * 100 ?>">
                        ...
                        <!-- Photo / Fond gradient -->
                        <div class="surv-card-photo<?= $has_photo ? ' has-bg-photo' : '' ?>"
                             <?= $has_photo ? 'style="--surv-bg-img: url(\''.e($photo_url).'\')"' : '' ?>>

                            <!-- Cercle photo centré -->
                            <div class="surv-photo-circle">
                                <?php if ($photo_url): ?>
