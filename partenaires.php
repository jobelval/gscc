...
if (empty($partenaires)) {
    $partenaires = [
        ['id'=>6,'nom'=>'Église de Jésus-Christ des Saints des Derniers Jours','description'=>'Composée d\'une communauté mondiale unie par une foi commune, l\'Église de Jésus-Christ des Saints des Derniers Jours se donne pour mission de vivre l\'Évangile à travers des actions concrètes de solidarité. Engagée aux côtés du Groupe de Support Contre le Cancer (GSCC) dès 2025, ce partenariat témoigne de leur dévouement envers le bien-être d\'autrui.','logo'=>'images/partenaires/jesus-christ.png','site_web'=>'#','type'=>'principal','ordre'=>1],
        ['id'=>5,'nom'=>'Fondation Haïtienne de la Santé et de l\'Éducation (FHASE)','description'=>'Organisation dédiée au renforcement des piliers fondamentaux de la société, la FHASE œuvre quotidiennement pour l\'amélioration de l\'accès aux soins de santé et à une éducation de qualité en Haïti. Partenaire du GSCC depuis 2023, la fondation apporte une dimension essentielle à nos actions grâce à sa vision intégrée du développement humain.','logo'=>'images/partenaires/fhase.png','site_web'=>'#','type'=>'principal','ordre'=>2],
        ['id'=>7,'nom'=>'Deka Group','description'=>'Fondée il y a environ 35 ans, Deka Group est une entreprise familiale de premier plan et l\'un des plus grands importateurs de produits de grande consommation en Haïti. Avec ses sept divisions spécialisées et son réseau de plus de 100 fournisseurs à travers le monde, Deka Group mobilise sa force pour soutenir durablement les actions de santé publique portées par le GSCC depuis 2020.','logo'=>'images/partenaires/deka_group.png','site_web'=>'#','type'=>'principal','ordre'=>3],
        ['id'=>3,'nom'=>'Fondation Sogebank','description'=>'Institution à but non lucratif reconnue d\'utilité publique, la Fondation Sogebank incarne l\'engagement social du Groupe Sogebank depuis sa création en 1993. En rejoignant les partenaires du Groupe de Support Contre le Cancer (GSCC) en 2025, la Fondation renforce son action en faveur de projets d\'intérêt collectif, contribuant ainsi de manière significative à la santé publique en Haïti.','logo'=>'images/partenaires/sogebank.png','site_web'=>'#','type'=>'principal','ordre'=>4],
        ['id'=>4,'nom'=>'Groupe Sogebank','description'=>'Filiale du Groupe Sogebank fondée en 1988, la Sogebel est une institution financière de référence dédiée aux besoins immobiliers des particuliers et des institutions. Engagée dans le développement socio-économique du pays, elle soutient fidèlement le Groupe de Support Contre le Cancer (GSCC) depuis 2020.','logo'=>'images/partenaires/sogebel.png','site_web'=>'#','type'=>'principal','ordre'=>5],
        ['id'=>2,'nom'=>'Carimpex','description'=>'Fort de plus de 20 ans d\'expertise dans le secteur du transport de fret en Haïti, Carimpex est un acteur clé de la logistique facilitant les échanges entre le pays et l\'international. Partenaire engagé du Groupe de Support Contre le Cancer (GSCC) depuis 2020, l\'entreprise met son sérieux et son professionnalisme au profit de notre cause.','logo'=>'images/partenaires/carimpex.png','site_web'=>'#','type'=>'principal','ordre'=>6],
        ['id'=>1,'nom'=>'Plasbag SA','description'=>'Entreprise leader dans la fabrication de produits plastiques, Plasbag SA met son expertise industrielle au service de la communauté. Soucieuse de son impact social, l\'entreprise soutient activement les initiatives du Groupe de Support Contre le Cancer (GSCC) depuis 2022. Ce partenariat solide témoigne de leur volonté d\'accompagner durablement la lutte contre le cancer et de contribuer au bien-être de la population haïtienne.','logo'=>'images/partenaires/plasbag.png','site_web'=>'https://www.facebook.com/plasbaght/?locale=fr_FR','type'=>'principal','ordre'=>7],
    ];
}
